...
export function Coverage() {
  return (
    <section id="cobertura" className="scroll-mt-20 border-t border-border bg-card/50">
      <div className="mx-auto w-full max-w-6xl px-4 py-16 sm:px-6 md:py-20">
        <div className="mx-auto flex max-w-2xl flex-col items-center gap-4 text-center">
          ...
          <h2 className="font-display text-3xl font-bold tracking-tight text-foreground text-balance sm:text-4xl">
            Protección concreta, sin letra chica
          </h2>
          <p className="text-lg leading-relaxed text-muted-foreground text-pretty">
            Un seguro de vida simple de entender, para ti y para quienes más quieres.
          </p>
        </div>
